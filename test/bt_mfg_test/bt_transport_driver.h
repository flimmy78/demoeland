...
typedef OSStatus (*bt_transport_driver_event_handler_t)   ( bt_transport_driver_event_t event );
typedef OSStatus (*bt_transport_driver_bus_read_handler_t)( bt_packet_t** packet );
